...
export const coworkingsData: CoworkingSpace[] = [
  ...
  createCoworking('cw_scott_weber_churchill', 'Scott.Weber Churchill', 'Praha', 'Praha', {
    amenities: ['wifi', 'meeting_rooms', 'kitchen', 'printer', 'reception', 'locker', 'phone_booth', 'air_conditioning', 'parking', '24h_access'],
    capacity: 80,
    areaM2: 1200,
    website: 'https://scottweber.cz/location/churchill/',
    photos: [{ id: 'cw_scott_weber_churchill_p1', url: 'https://images.unsplash.com/photo-1497366811353-6870744d04b2?auto=format&fit=crop&w=800&q=80', caption: 'Scott.Weber Churchill Vinohrady', isPrimary: true }],
    address: 'Italská 2581/67',
    phone: '+420 724 227 246',
    email: 'churchill@scottweber.cz',
    zipCode: '120 00',
    prices: { hourly: { enabled: false, from: null }, dayPass: { enabled: false, from: null }, openSpace: { enabled: true, from: 5000 }, fixDesk: { enabled: true, from: 5000 }, office: { enabled: true, from: 9000 } },
    shortDescription: 'Scott.Weber Churchill – servisovaný coworking a kanceláře na Vinohradech (Praha 2).',
  }),
  createCoworking('cw_scott_weber_blox', 'Scott.Weber Blox', 'Praha', 'Praha', {
    amenities: ['wifi', 'meeting_rooms', 'kitchen', 'printer', 'reception', 'locker', 'phone_booth', 'air_conditioning', 'parking', '24h_access'],
    capacity: 90,
    areaM2: 1300,
    website: 'https://scottweber.cz/location/blox/',
    photos: [{ id: 'cw_scott_weber_blox_p1', url: 'https://images.unsplash.com/photo-1497366811353-6870744d04b2?auto=format&fit=crop&w=800&q=80', caption: 'Scott.Weber Blox Dejvice', isPrimary: true }],
    address: 'Evropská 11/2758',
    phone: '+420 602 260 974',
    email: 'blox@scottweber.cz',
    zipCode: '160 00',
    prices: { hourly: { enabled: false, from: null }, dayPass: { enabled: false, from: null }, openSpace: { enabled: true, from: 5000 }, fixDesk: { enabled: true, from: 5000 }, office: { enabled: true, from: 8000 } },
    shortDescription: 'Scott.Weber Blox – servisovaný coworking a kanceláře v Dejvicích (Praha 6).',
  }),
