...
export const coworkingsData: CoworkingSpace[] = [
  ...
  createCoworking('cw_worklounge_prikopy', 'WorkLounge Příkopy', 'Praha', 'Praha', {
    ...
    capacity: 70,
    areaM2: 1100,
    website: 'https://www.worklounge.com/cs/prikopy',
    photos: [{ id: 'cw_worklounge_prikopy_p1', url: 'https://www.worklounge.com/files/2883-home-page-o-nas-cs.webp', caption: 'WorkLounge Příkopy', isPrimary: true }],
    address: 'Na Příkopě 14',
    phone: '+420 770 152 602',
    email: 'prikopy@worklounge.com',
    zipCode: '110 00',
    prices: { hourly: { enabled: false, from: null }, dayPass: { enabled: true, from: 490 }, openSpace: { enabled: true, from: 3900 }, fixDesk: { enabled: false, from: null }, office: { enabled: false, from: null } },
    shortDescription: 'Prémiový coworking na Příkopě — recepce, zasedačky a event prostory v centru Prahy.',
  }),
  createCoworking('cw_worklounge_vaclavak', 'WorkLounge Václavské náměstí', 'Praha', 'Praha', {
    amenities: ['wifi', 'meeting_rooms', 'kitchen', 'printer', 'reception', 'locker', 'phone_booth', 'air_conditioning'],
    capacity: 60,
    areaM2: 900,
    website: 'https://www.worklounge.com/cs/wenceslas-square',
    photos: [{ id: 'cw_worklounge_vaclavak_p1', url: 'https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&w=800&q=80', caption: 'WorkLounge Václavské náměstí', isPrimary: true }],
    address: 'Václavské náměstí 3',
    phone: '+420 770 152 602',
    email: 'vaclavak@worklounge.com',
    zipCode: '110 00',
    prices: { hourly: { enabled: false, from: null }, dayPass: { enabled: true, from: 490 }, openSpace: { enabled: true, from: 3900 }, fixDesk: { enabled: false, from: null }, office: { enabled: false, from: null } },
    shortDescription: 'Servisované kanceláře a coworking přímo na Václavském náměstí v Praze 1.',
  }),
  createCoworking('cw_worklounge_karlin', 'WorkLounge Karlín', 'Praha', 'Praha', {
    amenities: ['wifi', 'meeting_rooms', 'kitchen', 'printer', 'reception', 'locker', 'phone_booth', 'air_conditioning', 'parking'],
    capacity: 80,
    areaM2: 1200,
    website: 'https://www.worklounge.com/cs/forum-karlin',
    photos: [{ id: 'cw_worklounge_karlin_p1', url: 'https://images.unsplash.com/photo-1497366811353-6870744d04b2?auto=format&fit=crop&w=800&q=80', caption: 'WorkLounge Karlín', isPrimary: true }],
    address: 'Pernerova 51',
    phone: '+420 770 152 602',
    email: 'karlin@worklounge.com',
    zipCode: '186 00',
    prices: { hourly: { enabled: false, from: null }, dayPass: { enabled: true, from: 490 }, openSpace: { enabled: true, from: 3900 }, fixDesk: { enabled: false, from: null }, office: { enabled: false, from: null } },
    shortDescription: 'Coworking v Karlíně, kousek od metra Křižíkova — Forum Karlín v Praze 8.',
  }),
  createCoworking('cw_worklounge_smichov', 'WorkLounge Smíchov', 'Praha', 'Praha', {
    amenities: ['wifi', 'meeting_rooms', 'kitchen', 'printer', 'reception', 'locker', 'phone_booth', 'air_conditioning'],
    capacity: 60,
    areaM2: 900,
    website: 'https://www.worklounge.com/cs/smichov',
    photos: [{ id: 'cw_worklounge_smichov_p1', url: 'https://images.unsplash.com/photo-1604328698692-f76ea9498e76?auto=format&fit=crop&w=800&q=80', caption: 'WorkLounge Smíchov', isPrimary: true }],
    address: 'Plzeňská 155/113',
    phone: '+420 770 152 602',
    email: 'smichov@worklounge.com',
    zipCode: '150 00',
    prices: { hourly: { enabled: false, from: null }, dayPass: { enabled: true, from: 490 }, openSpace: { enabled: true, from: 3900 }, fixDesk: { enabled: false, from: null }, office: { enabled: false, from: null } },
    shortDescription: 'Coworking na Smíchově u zastávky Klamovka v Praze 5.',
  }),
  createCoworking('cw_worklounge_dejvice', 'WorkLounge Dejvice', 'Praha', 'Praha', {
    amenities: ['wifi', 'meeting_rooms', 'kitchen', 'printer', 'reception', 'locker', 'phone_booth', 'air_conditioning'],
    capacity: 60,
    areaM2: 900,
    website: 'https://www.worklounge.com/cs/dejvice',
    photos: [{ id: 'cw_worklounge_dejvice_p1', url: 'https://images.unsplash.com/photo-1556761175-5973dc0f32e7?auto=format&fit=crop&w=800&q=80', caption: 'WorkLounge Dejvice', isPrimary: true }],
    address: 'Generála Píky 430/26',
    phone: '+420 770 152 602',
    email: 'dejvice@worklounge.com',
    zipCode: '160 00',
    prices: { hourly: { enabled: false, from: null }, dayPass: { enabled: true, from: 490 }, openSpace: { enabled: true, from: 3900 }, fixDesk: { enabled: false, from: null }, office: { enabled: false, from: null } },
    shortDescription: 'Coworking v Dejvicích s dostupností metrem A (Dejvická) a tramvají v Praze 6.',
  }),
  createCoworking('cw_worklounge_pankrac', 'WorkLounge Pankrác', 'Praha', 'Praha', {
    amenities: ['wifi', 'meeting_rooms', 'kitchen', 'printer', 'reception', 'locker', 'phone_booth', 'air_conditioning', 'parking'],
    capacity: 80,
    areaM2: 1200,
    website: 'https://www.worklounge.com/cs/pankrac',
    photos: [{ id: 'cw_worklounge_pankrac_p1', url: 'https://images.unsplash.com/photo-1517502884422-41eaead166d4?auto=format&fit=crop&w=800&q=80', caption: 'WorkLounge Pankrác', isPrimary: true }],
    address: 'Hvězdova 1689/2a',
    phone: '+420 770 152 602',
    email: 'pankrac@worklounge.com',
    zipCode: '140 00',
    prices: { hourly: { enabled: false, from: null }, dayPass: { enabled: true, from: 490 }, openSpace: { enabled: true, from: 3900 }, fixDesk: { enabled: false, from: null }, office: { enabled: false, from: null } },
    shortDescription: 'Coworking ve 2. patře City Point budovy na Pankráci s výhledem na V Tower.',
  }),
  createCoworking('cw_worklounge_zizkov', 'WorkLounge Žižkov', 'Praha', 'Praha', {
    amenities: ['wifi', 'meeting_rooms', 'kitchen', 'printer', 'reception', 'locker', 'phone_booth', 'air_conditioning'],
    capacity: 50,
    areaM2: 800,
    website: 'https://www.worklounge.com/cs/zizkov',
    photos: [{ id: 'cw_worklounge_zizkov_p1', url: 'https://images.unsplash.com/photo-1521737604893-d14cc237f11d?auto=format&fit=crop&w=800&q=80', caption: 'WorkLounge Žižkov', isPrimary: true }],
    address: 'Žerotínova 32',
    phone: '+420 770 152 602',
    email: 'zizkov@worklounge.com',
    zipCode: '130 00',
    prices: { hourly: { enabled: false, from: null }, dayPass: { enabled: true, from: 490 }, openSpace: { enabled: true, from: 3900 }, fixDesk: { enabled: false, from: null }, office: { enabled: false, from: null } },
    shortDescription: 'Coworking na Žižkově pro freelancery a malé týmy v Praze 3.',
  }),
