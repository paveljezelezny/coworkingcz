...
function ageLabelFromDate(d: Date | string): string {
...
// Small helper exposed for server side mapping (kept colocated)
export function listingKindFromCategory(category: string): { kind: 'Nabídka' | 'Poptávka'; tone: 'amber' | 'moss'; label: string } {
  ...
  const labelMap: Record<string, string> = {
    job_offer: 'Nabídka práce', job_seeking: 'Hledám práci',
    service_offer: 'Nabízím služby', service_seeking: 'Hledám služby',
    item_for_sale: 'Prodám', item_wanted: 'Koupím',
  };
  return {
