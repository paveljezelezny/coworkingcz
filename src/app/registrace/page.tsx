...
import { Mail, Lock, User, Eye, EyeOff, Building2, AlertCircle, CheckCircle } from 'lucide-react';
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-orange-50 flex items-center justify-center">
        <div className="bg-white rounded-2xl shadow-xl p-10 text-center max-w-md">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Účet vytvořen!</h2>
          <p className="text-gray-600">Přihlašuji tě automaticky...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8 sm:p-10">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-gray-900 mb-2">Registrace</h1>
          </div>

          {/* Tabs */}
          <div className="grid grid-cols-2 gap-2 mb-8 bg-gray-100 p-1 rounded-xl">
            <button
          ...
          {tab === 'coworking' && (
            <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg text-sm text-blue-800">
              <strong>Správce coworkingu:</strong> Po registraci si přivlastníš svůj coworking a budeš moct editovat celý profil.
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 px-4 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition-colors disabled:opacity-60 flex items-center justify-center"
            >
              {loading ? (
