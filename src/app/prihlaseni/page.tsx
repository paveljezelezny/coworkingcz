  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-orange-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8 sm:p-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center gap-2 cursor-pointer">
                ...
                />
                <span className="text-gray-700">Zapamatovat si mě</span>
              </label>
              <Link
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-white text-gray-600">nebo</span>
            </div>
          </div>

          {/* Social Login */}
          <div className="space-y-3">
            <button className="w-full py-3 px-4 border-2 border-gray-200 text-gray-900 font-semibold rounded-lg hover:bg-gray-50 transition-colors flex items-center justify-center gap-2">
        ...
        {/* Info Box */}
        <div className="mt-6 p-4 bg-white rounded-lg border border-gray-100 text-sm text-gray-600">
          <p className="flex items-start gap-2">
            <span className="text-lg">💡</span>
            <span>
              Nový na platformě? Zaregistruj se jako{' '}
              <Link href="/registrace" className="text-blue-600 font-semibold hover:underline">
                coworker
              </Link>
              {' '}nebo{' '}
              <Link href="/registrace" className="text-blue-600 font-semibold hover:underline">
